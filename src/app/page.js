      ...
      <section className="hero h-[950px] lg:h-[800px] heroBG">
        <div className="hero-content text-dark text-center">
          <div className="max-w-xl -mt-[250px] lg:-mt-[150px]">
            <h1 className="mb-5 text-4xl md:text-5xl font-bold leading-normal tracking-normal capitalize">
      ...
      <section className="mt-[650px]">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-center">
            <div className="card w-11/12 mx-auto my-3 lg:my-0 md:w-1/3  bg-base-100 box-shadow lg:mx-4 transition-all duration-200 ease-in">
              <figure className="mt-12">
                <div className="bg-primary flex items-center justify-center h-24 w-24 rounded-full text-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
